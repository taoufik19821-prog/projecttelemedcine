...
const AddDoctor = () => {
    ...
    const [ethAddress, setAddressETH] = useState('')
            ...
            <div className='bg-white px-8 py-8 border border-gray-200 rounded w-full max-w-4xl max-h-[80vh] overflow-y-scroll'>
                ...
                <div className='flex flex-col lg:flex-row items-start gap-10 text-gray-600'>
                    ...
                    <div className='w-full flex flex-col lg:flex-1 gap-4'>
                        ...
                        <div className='flex-1 flex flex-col gap-1'>
                            <p>Compte ETH</p>
                            <input onChange={(e) => setAddressETH(e.target.value)} value={ethAddress} className='border border-gray-200 rounded px-3 py-2 ' type="text" placeholder='Adresse compte ETH'  />
